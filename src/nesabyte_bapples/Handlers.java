...
public class Handlers {
    ...
    for (String un : unlinks) {
      ...
      try {
        ...
        if (code == 400 || code == 404) {
          System.out.println(
              Cleaner.RED + "[ " + code + " ]   BAD APPLE     : " + str.toString() + Cleaner.RESET);
          Bcounter++;
        } else if (code == 200) {
          System.out.println(
              Cleaner.GREEN
          ...
          System.out.println(
              Cleaner.YELLOW + "[ ??? ]   UNKNOWN APPLE : " + str.toString() + Cleaner.RESET);
          Ucounter++;
        } else {
          System.out.println(
              Cleaner.YELLOW
  ...
  public static void bappleHelp() {
    System.out.println(
        "-------------------------------------------------------------------------------------");
    System.out.println(
        "- WELCOME TO BAPPLES! Finding bad apples from any LINKS or HTML files               -");
    System.out.println(
        "-------------------------------------------------------------------------------------");
    System.out.println(
        "-      --v or --version     | to check the Bapple version                           -");
    System.out.println(
        "-      --h or --help        | to check the Bapple help                              -");
    System.out.println(
        "-      <filename>           | to validate links within a file                       -");
    System.out.println(
        "-      --200                | to list urls with status code: SUCCESS                -");
    System.out.println(
        "-      --400 or --404       | to list urls with status code: CLIENT ERRORS          -");
    System.out.println(
        "-      --XXX                | to list urls with status code: UNKNOWNS               -");
    System.out.println(
        "-      --secure             | to check URLS with http:// if they work with https:// -");
    System.out.println(
        "-      --all                | to list urls with all status                          -");
    System.out.println(
        "-      --good               | to list urls with good status code: 200               -");
    System.out.println(
        "-      --bad                | to list urls with bad status code: 404 and 400        -");
    System.out.println(
        "-      --i or --ignore      | to list urls except ignore url list                   -");
    System.out.println(
        "-      --lh or --localhost  | to check telescope links                              -");
    System.out.println(
        "-------------------------------------------------------------------------------------");
  }
  ...
  public static void bappleResults(int goodCounter, int badCounter, int unknownCounter) {
    ...
    System.out.println(
        Cleaner.YELLOW + "          Unknown apples: " + unknownCounter + Cleaner.RESET);
    System.out.println("--------------------------------------------------------");
  }
  ...
  public static void Results(
      int statcode, HashSet<String> aLink, int Gcounter, int Bcounter, int Ucounter)
      throws Exception {
    // if the user wants the specific status code of 200, it will only print the links with status
    // code 200
    if (statcode == 200) {
      ...
      // if the user wants the specific status code of 400 or 404, it will only print the links with
  ...
  public static String HtmlReader(String file) throws IOException {
    ...
    while ((inputLine = reader.readLine()) != null) a.append(inputLine);
    reader.close();
    return a.toString();
  }
}
